...
namespace tk205  {
	...
	namespace rs0005_ns  {
		...
		public:
			...
			LookupVariablesStruct calculate_performance (double shaft_power, double shaft_rotational_speed, Btwxt::InterpolationMethod performance_interpolation_method = Btwxt::InterpolationMethod::linear);
		};
		class Performance  {
		public:
